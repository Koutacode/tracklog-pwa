...
- [x] `個人アプリ` 配下に `TrackLog更新 2026-05-16 v0.1.8 更新通知誤検知修正とObsidian送信削除` を追加。
- [x] `TrackLog運行アシスト｜機能・アップデート・配布情報` 配下に `v0.1.8 配布情報 2026-05-16` を追加。
- [x] `改善点` 配下に `改善記録 2026-05-16 更新通知誤検知とObsidian送信削除` を追加。
