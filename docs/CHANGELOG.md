...
- 未取得理由と次回再試行日時を表示。名前検索のサーバー更新は公開時に反映が必要
- 候補版は `versionName=0.1.62` / `versionCode=60`。公開・実機更新前の検証結果は `docs/KEEP_IMPROVEMENTS_2026-09-23.md` に記録
